...
set_property PACKAGE_PIN V16 [get_ports rev]					
...
##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports EN1]					
...
##Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports EN2]					
...
##Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports EN3]					
...
###Pmod Header JB
###Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports {hall_data_out[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {hall_data_out[2]}]
###Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports {hall_data_out[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {hall_data_out[1]}]
###Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports {hall_data_out[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {hall_data_out[0]}]
##Sch name = JB4
...
#Pmod Header JXADC
#Sch name = XA1_P
set_property PACKAGE_PIN J3 [get_ports {hall_data_in[2]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {hall_data_in[2]}]
#Sch name = XA2_P
set_property PACKAGE_PIN L3 [get_ports {hall_data_in[1]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {hall_data_in[1]}]
#Sch name = XA3_P
set_property PACKAGE_PIN M2 [get_ports {hall_data_in[0]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {hall_data_in[0]}]
##Sch name = XA4_P
